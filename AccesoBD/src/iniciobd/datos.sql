...
INSERT INTO public.departamentos (id_departamento, nombre_departamento, presupuesto, id_jefe)
VALUES (0, 'navidad', 1000, 0),
       (1, 'caramelos', 1600, 1);

INSERT INTO public.programadores (id_programador, nombre_programador, experiencia, salario, id_departamento, lenguajes)
VALUES (0, 'jefejuan', '20', 3, 0, 'Java;Kotlin;Python'),
       (1, 'jefejose', '8', 5, 1, 'C'),
